...
| `design-taste-frontend` | `third-party-adapted` | [`Leonxlnx/taste-skill@e988add`](https://github.com/Leonxlnx/taste-skill/blob/e988add20dab0fa97d7a76781c48961c8184288e/skills/taste-skill/SKILL.md) | MIT, copyright 2026 Leonxlnx. The pinned instruction body is retained; local changes add license, provenance, and Codex/OpenAI packaging metadata. |
| `rebuttal-response-skills` | `third-party-adapted` | [`wanshuiyin/Auto-claude-code-research-in-sleep@e513263`](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/blob/e5132630e26e26e24d256a149b85f17b0cc6dcac/skills/skills-codex/rebuttal/SKILL.md) | MIT, copyright 2026 wanshuiyin. The local workflow has been substantially rewritten and expanded for evidence-ledger management, guided risk decisions, venue validation, and blind reviewer/AC audits; the pinned provenance and upstream license remain preserved. |
